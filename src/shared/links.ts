...
export const EXTERNAL_LINKS: Readonly<Record<ExternalLinkTarget, string>> = {
  repository: 'https://github.com/denggaopan/codeflai',
  changelog: 'https://github.com/denggaopan/codeflai/releases',
  download: 'https://github.com/denggaopan/codeflai/releases/latest'
}
