...
describe('TitleBar', () => {
  ...
  it('unlocks fast double-size rockets from the 32nd click onwards, even after a pause', () => {
    ...
    expect(rockets()).toHaveLength(32)
    ...
    expect(grand!.querySelector('.rocket-flight-exhaust')).not.toBeNull()
    now.mockReturnValue(120_000)
    fireEvent.click(brand)
    expect(document.querySelectorAll('.rocket-flight-grand')).toHaveLength(2)
    expect(flights[32].keyframes.length).toBeGreaterThan(20)
