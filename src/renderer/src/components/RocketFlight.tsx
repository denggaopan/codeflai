      ...
      <div className="rocket-flight-body" ref={bodyRef}>
        ...
        <svg className="rocket-flight-art" viewBox="0 0 32 44" width="32" height="44" fill="none">
          <defs>
            ...
            <linearGradient id={`${artId}-fin`} x1="4" y1="26" x2="28" y2="38" gradientUnits="userSpaceOnUse">
              <stop offset="0" stopColor="#c77dff" />
              <stop offset="1" stopColor="#7b2cbf" />
            </linearGradient>
            <linearGradient id={`${artId}-flame`} x1="16" y1="32" x2="16" y2="44" gradientUnits="userSpaceOnUse">
          ...
          <path d="M11 25 4 34l7 1z" fill={`url(#${artId}-fin)`} />
          <path d="M21 25l7 9-7 1z" fill={`url(#${artId}-fin)`} />
          ...
          <g className="rocket-flight-flame">
            <path d="M16 44c-3.2-3-4.8-6-4.8-9h9.6c0 3-1.6 6-4.8 9z" fill={`url(#${artId}-flame)`} />
          </g>
        </svg>
      </div>
    </div>,
