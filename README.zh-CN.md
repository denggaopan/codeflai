...
任意滚动 60 秒内连续点击，且相邻点击间隔不超过 3 秒：达到 32 次解锁双发，达到 48 次解锁三发，之后的连续点击保持已解锁数量。火箭均保持原尺寸，带明亮喷焰和光晕。每枚火箭独立随机选择飞行方向、转折位置和弧线高度，沿钱学森式滑翔轨迹快速驶离窗口，全程约两秒，机头始终朝向飞行方向。点击间隔超过 3 秒就重新计数，下一次点击恢复发射一枚；恰好 3 秒仍算连续。重新打开或刷新窗口也会重置计数。
